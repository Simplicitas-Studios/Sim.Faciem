...
{
    public abstract class Bindable<T> : IDataSourceViewHashProvider, INotifyBindablePropertyChanged
        where T : Bindable<T>
    {
        ...
        protected void SetProperty<TItem>(ref TItem item, TItem newValue, bool checkEqual = true,
